{
  ...
  "database": {
    "type": "mongodb",
    "uriMongodb": "mongodb+srv://risingabir1:amPSSuawHXmkSxKk@cluster0.bpdm4.mongodb.net/Maki-BOT?retryWrites=true&w=majority&appName=Cluster0",
  ...
  "credentials": {
    "gmailAccount": {
      "email": "adilhasan2642@gmail.com",
      "clientId": "363437851214-e9k6ji3vigdjil0teomk9cj84sbb6que.apps.googleusercontent.com",
      "clientSecret": "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",
      "refreshToken": "1//04lWWOTuXE2fPCgYIARAAGAQSNwF-L9IrebEUTetejDsxqYiQyGMPLWyomqGVU_get6rKhEgQKxd_XjlpBhe9p7UINN-ozOSRp18",
      "apiKey": ""
    },
    "gRecaptcha": {
      "siteKey": "6LdlSq0qAAAAAHbyD0GGEnwzEqruB3u_0Mtlokh-",
      "secretKey": "6LdlSq0qAAAAACn45OnOOvdXCLaTeGkXR0IxbC94"
    }
  },
  "dashBoard": {
    "enable": true,
